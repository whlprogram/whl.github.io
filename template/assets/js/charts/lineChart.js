    ...
    series: [
        {
            ...
            type:'line',
            stack: '总量',
            data:[12, 11, 5, 5, 6, 7, 5]
        },
        {
            name:'北京',
            type:'line',
            stack: '总量',
            data:[15, 15, 18, 13, 12, 11, 11]
        },
        {
            name:'郑州',
            type:'line',
            stack: '总量',
            data:[18, 22, 23, 19, 18, 17, 15]
        },
        {
			name:'武汉',
            type:'line',
            stack: '总量',
            data:[20, 22, 23, 25, 25, 22, 18]
        },
        {
            name:'广州',
            type:'line',
            stack: '总量',
            data:[27, 27, 25, 26, 28, 29, 28]
        }
    ]
};
    ...
    series: [
        {
            ...
            type:'line',
            step: 'start',
            data:[12, 14, 14, 14, 16, 14, 15]
        },
        {
            name:'重庆',
            type:'line',
            step: 'middle',
            data:[23, 24, 22, 19, 17, 17, 21]
        },
        {
            name:'武汉',
            type:'line',
